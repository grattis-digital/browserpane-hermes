...
export class GpuStatusError extends Error {
  static codes = Object.freeze(['GPU_STATUS_MISSING', 'GPU_RENDERER_MISMATCH', 'GPU_SANDBOX_INACTIVE',
    ...
    'GPU_CDP_RESPONSE_INVALID', 'GPU_VIDEO_DECODE_DISABLED', 'GPU_VIDEO_H264_UNAVAILABLE',
    'GPU_VIDEO_MODE_INVALID', 'GPU_CHECK_FAILED', 'GPU_CAPTURE_HEALTH_SOCKET_INVALID',
    'GPU_CAPTURE_HEALTH_TIMEOUT', 'GPU_CAPTURE_UNHEALTHY', 'GPU_CAPTURE_UNAVAILABLE',
    'GPU_CAPTURE_HEALTH_TRUNCATED']);
